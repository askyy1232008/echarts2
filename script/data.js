...
var iconArray1=[
    'path://M100,0 L41.22,180.90 L195.10,69.09 L4.89,69.09 L158.77,180.90 z',//五角星
];
...
var legendData=[];
var index=0;
for(var item in geoCoordMap1)
{
    var geoObj1=geoCoordMap1[item];
    data1.push({
        name:item+'',
        value:[geoObj1[0],geoObj1[1],index],
        symbol:iconArray1[index],
        itemStyle: {
            normal: {
                color: 'red',
                shadowBlur: 10,
...
var lineContainerData = [127954,149682,167564,183256,204560,225000];
var lineb = [266,384,498,546,687,766];
var linea = [15862,16456,17689,18799,20856,22324];
var xData = ['2018-08','2018-09','2018-10','2018-11','2018-12','2019-01'];
